...
Pour la r\'{e}alisation du  projet nous utiliserons 4 cat\'{e}gories de fonctions : celles relatives aux moteurs, aux capteurs, à la connexion Bluetooth et \'{e}ventuellement d'autres fonctions permettant la coh\'{e}sion de l'ensemble.
...
que celui-ci possède une API assez developpée, sa syntaxe s'inspirant
...
Si elle est grise ou blanche, le robot maître s'arrête et ordonne au
...
Les deux robots recommencent ensuite le même cycle de fonctionnement.
