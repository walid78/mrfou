\section{Réduction API NXC}
Pour la réalisation du  projet nous utiliserons 4 catégories de fonction : celles relatives aux moteurs, aux capteurs , à la connexion Bluetooth et éventuellement d'autres fonctions permettant la cohésion de l'ensemble.
...
\begin{verbatim}
	...
	Acquire("mutex"); 
	Release("mutex"); 
	Precedes("task1","task2","taskn"); //Permet l'exécution de taches simultanée
