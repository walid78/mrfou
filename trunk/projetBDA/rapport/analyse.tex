\section{Analyse de notre base de donnée}

\begin{table}[h]
%\begin{center}
\begin{tabular}{|l|l|l|l|}
\hline
\multicolumn{4}{|c|}{Calcul de l'occupation mémoire / physique}\\
\hline
...
\begin{itemize}
\item De T1 Ã  T10:La table de facturation segmentée par année
\item T11 :La table de LOG qui enregistre tous les évenements sur la base
\item T0: Toutes les autres tables.
\end{itemize}

Total Occupation Tablespace T0 : 15,4 Mo\\
T1 Ã  T10 = 168.24 Mo\\
Chaque Tablespace devrait donc faire environ 17Mo.(Nous arrondiront Ã  20 Mo par sécurité chacun de nos tablespaces).
