...
create table Hotel(	ID_Hotel integer, ID_Dest integer,Nom_Hotel varchar2,Addresse varchar2,
					ID_Classe integer, capac_S integer, capac_D integer) ;		
...
create table Client(ID_Client integer,Addresse varchar2,Tel number(10), Nom varchar2,Prenom varchar2, Age integer, 
					Email varchar2,Classe_sociale varchar2, ID Dest_Preferee integer, Investissement_Moyen float) ;

create table Facturation(ID Facture integer, Date Facture timestamp, 
						Addresse Client varchar2, Tel number(10), Nom varchar2, Prenom varchar2, 
						Nom_Dest Varchar2, Pays Dest varchar2, 
						Nom_Hotel varchar2, Address_Hotel varchar2,Classe_Hotel integer, Prix_S float, Prix_D float,
						Nom circuit varchar2, Duree_sejour integer, Prix_Circuit float, 
						Prix_Vol_Enfant float,Prix_Vol_Adulte float, 
						Description_Sejour varchar2, Coeff_Sejour float,
